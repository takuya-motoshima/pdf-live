export default {
  "action": {
    ...
    "insertBlankPageAbove": "Вставить пустую страницу выше",
    "insertBlankPageBelow": "Вставьте пустую страницу ниже",
  ...
  "annotation": {
    ...
    "radioButtonFormField": "Поле RadioButton",
  ...
  "component": {
    ...
    "viewControlsOverlay": "Изменить вид",
  ...
  "message": {
    ...
    "enterContentEditingMode": "Вы собираетесь войти в режим редактирования текста.",
    "existingAnnotationWarning": "Существующие аннотации могут не совпадать с текстом после его редактирования.",
    "changesCannotBeUndone": "Любые внесенные изменения не могут быть отменены.",
    ...
    "layerVisibililtyNoChange": "Видимость слоя не может быть изменена",
  ...
  "option": {
    ...
    "print": {
      ...
      "addWatermarkSettings": "Добавить настройки водяного знака"
    },
    "printInfo": {
      "author": "Автор",
      "subject": "Предмет",
    ...
    "stylePopup": {
      ...
      "colors": "Цвета",
      "invalidFontSize": "Размер шрифта должен быть меньше",
  ...
  "warning": {
    "deletePage": {
      ...
      "deleteMessage": "Вы уверены, что хотите удалить выбранные страницы? Это не может быть отменено",
  ...
  "link": {
    ...
    "enterpage": "Выберите номер страницы, на которую вы хотите сослаться",
    "urlLink": "URL-ссылка"
  },
  "Model3D": {
