export default {
  "action": {
    ...
    "zoomIn": "Heranzoomen",
    "zoomOut": "Rauszoomen",
    "zoomSet": "Stellen Sie den Zoom ein",
    ...
    "fileAttachmentDownload": "Laden Sie die angehängte Datei herunter",
  ...
  "annotation": {
    ...
    "radioButtonFormField": "RadioButton-Feld",
  ...
  "component": {
    ...
    "redaction": "Schwärzen",
    "viewControlsOverlay": "Anzeigeoptionen",
  ...
  "message": {
    ...
    "warning": "Warnung",
    "enterContentEditingMode": "Sie sind dabei, in den Textbearbeitungsmodus zu wechseln.",
    "existingAnnotationWarning": "Vorhandene Anmerkungen stimmen möglicherweise nicht mit dem Text überein, nachdem dieser bearbeitet wurde.",
    "changesCannotBeUndone": "Vorgenommene Änderungen können nicht rückgängig gemacht werden.",
    ...
    "layerVisibililtyNoChange": "Die Sichtbarkeit der Ebene kann nicht geändert werden",
    "untitled": "Ohne Titel",
  ...
  "option": {
    ...
    "print": {
      ...
      "addWatermarkSettings": "Wasserzeicheneinstellungen hinzufügen"
    },
    "printInfo": {
      "author": "Autor",
      "subject": "Betreff",
    ...
    "signatureOverlay": {
      "addSignature": "Eine Unterschrift hinzufügen"
    },
    "signatureModal": {
    ...
    "stylePopup": {
      "textStyle": "Textstil",
      "colors": "Farben",
      "invalidFontSize": "Schriftgröße muss kleiner sein als",
  ...
  "link": {
    "url": "URL",
    "page": "Seite",
    "enterurl": "Geben Sie die URL ein, zu der Sie einen Link erstellen möchten",
    "enterpage": "Wählen Sie die Seitennummer aus, zu der Sie einen Link erstellen möchten",
    "urlLink": "URL-Link"
  },
  "Model3D": {
  ...
  "OpenFile": {
    ...
    "existingFile": "Datei ist bereits geöffnet"
  },
  "datePicker": {
