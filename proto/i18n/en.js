export default {
  "action": {
    ...
    "insertPage": "Page Insertion",
    "insertBlankPageAbove": "Insert blank page above",
    "insertBlankPageBelow": "Insert blank page below",
  ...
  "message": {
    ...
    "warning": "Warning",
    "enterContentEditingMode": "You are about to enter content editing mode.",
    "existingAnnotationWarning": "Existing annotations may not match up with the text after it has been edited.",
    "changesCannotBeUndone": "Any changes made cannot be undone.",
  ...
  "option": {
    ...
    "print": {
      ...
      "addWatermarkSettings": "Add Watermark"
    },
    "printInfo": {
      "author": "Author",
      "subject": "Subject",
    ...
    "signatureOverlay": {
      "addSignature": "Add New Signature"
    },
    "signatureModal": {
    ...
    "pageReplacementModal": {
      ...
      "pageReplaceInputLabel": "Replace Page(s)",
    ...
    "stylePopup": {
      ...
      "colors": "Colors",
      "invalidFontSize": "Font size must be less than ",
  ...
  "link": {
    ...
    "enterpage": "Select the page number you would like to link to",
    "urlLink": "URL link"
  },
  "Model3D": {
    "add3D": "Add 3D object",
  ...
  "digitalSignatureVerification": {
    ...
    "permissionStatus": {
      ...
      "hasAllowedChanges": "The document has changes that are allowed by the signatures permissions settings.",
      "invalidatedByDisallowedChanges": "The document has changes that are disallowed by the signatures permissions settings.",
