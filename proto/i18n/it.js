export default {
  "action": {
    ...
    "insertBlankPageAbove": "Inserisci una pagina vuota sopra",
    "insertBlankPageBelow": "Inserisci una pagina vuota qui sotto",
  ...
  "annotation": {
    ...
    "radioButtonFormField": "Campo RadioButton",
  ...
  "component": {
    ...
    "redaction": "redazione",
    "viewControlsOverlay": "Visualizza i controlli",
  ...
  "message": {
    ...
    "enterContentEditingMode": "Stai per accedere alla modalità di modifica del testo.",
    "existingAnnotationWarning": "Le annotazioni esistenti potrebbero non corrispondere al testo dopo che è stato modificato.",
    "changesCannotBeUndone": "Eventuali modifiche apportate non possono essere annullate.",
    ...
    "layerVisibililtyNoChange": "La visibilità del livello non può essere modificata",
  ...
  "option": {
    ...
    "print": {
      ...
      "addWatermarkSettings": "Aggiungi impostazioni filigrana"
    },
    "printInfo": {
      "author": "Autore",
      "subject": "Soggetto",
    ...
    "pageReplacementModal": {
      "dragAndDrop": "Trascina e rilascia il tuo file qui",
      "or": "O",
      "chooseFile": "Scegli un file",
    ...
    "stylePopup": {
      ...
      "colors": "Colori",
      "invalidFontSize": "La dimensione del carattere deve essere inferiore a",
  ...
  "warning": {
    "deletePage": {
      ...
      "deleteMessage": "Sei sicuro di voler eliminare le pagine selezionate. Questo non può essere annullato",
  ...
  "link": {
    ...
    "enterpage": "Seleziona il numero di pagina che desideri collegare",
