export default {
  "action": {
    ...
    "insertBlankPageAbove": "Insérer une page vierge ci-dessus",
    "insertBlankPageBelow": "Insérez une page vierge ci-dessous",
  ...
  "annotation": {
    ...
    "freehand": "Stylo",
    "freeHandHighlight": "Mise en évidence de la main libre",
    ...
    "radioButtonFormField": "Champ RadioButton",
  ...
  "message": {
    ...
    "enterContentEditingMode": "Vous êtes sur le point d'entrer en mode d'édition de texte.",
    "existingAnnotationWarning": "Les annotations existantes peuvent ne pas correspondre au texte une fois qu'il a été modifié.",
    "changesCannotBeUndone": "Toute modification apportée ne peut être annulée.",
    ...
    "layerVisibililtyNoChange": "La visibilité de la couche ne peut pas être modifiée",
    "untitled": "Sans titre",
  ...
  "option": {
    ...
    "documentControls": {
      "placeholder": "Entrez les pages à sélectionner, c'est-à-dire 2, 5-9",
    ...
    "print": {
      ...
      "addWatermarkSettings": "Ajouter des paramètres de filigrane"
    },
    "printInfo": {
      "author": "Auteur",
      "subject": "Sujet",
    ...
    "stylePopup": {
      ...
      "colors": "Couleurs",
      "invalidFontSize": "La taille de la police doit être inférieure à",
  ...
  "warning": {
    "deletePage": {
      ...
      "deleteMessage": "Voulez-vous vraiment supprimer les pages sélectionnées? Ceci ne pourra pas être annulé",
    ...
    "selectPage": {
      ...
      "selectMessage": "Veuillez sélectionner des pages et réessayer."
    },
    "colorPicker": {
  ...
  "link": {
    ...
    "enterpage": "Sélectionnez le numéro de page que vous souhaitez lier",
    "urlLink": "Lien URL"
  },
  "Model3D": {
